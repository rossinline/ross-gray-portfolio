      ...
      <div class="container mx-auto">
        ...
        <div class="w-full space-y-10">
          <collapsible-widget
            ...
            image="../assets/ruddocks-logo.png"
          />
          <collapsible-widget
          ...
          <collapsible-widget
            ...
            description="Preparation and organisation of events to cater for, by packing vans for
travel, preparing foods and waiting on for customers when the events were
live, this involved long hours requiring teamwork, adaptability and initiative
